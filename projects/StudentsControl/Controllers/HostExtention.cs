 /* namespace Controllers
{
    ...
    public static class HostExtention
    {
        public static IHost AddTestData(this IHost host)
     {
            ...
            LecturerEntity onotoliy = new LecturerEntity { Id = Guid.NewGuid(), Name = "Onotoliy" };
            ...
            StudentEntity tom = new StudentEntity { Id = Guid.NewGuid(), Course = cSharp, Name = "Tom", LectureAttandance = new List<LectureEntity>() };
            StudentEntity alice = new StudentEntity { Id = Guid.NewGuid(), Course = cSharp, Name = "Alice", LectureAttandance = new List<LectureEntity>() };
            StudentEntity bob = new StudentEntity { Id = Guid.NewGuid(), Course = cSharp, Name = "Bob", LectureAttandance = new List<LectureEntity>() };
            StudentEntity sam = new StudentEntity { Id = Guid.NewGuid(), Course = cSharp, Name = "Sam", LectureAttandance = new List<LectureEntity>() };
            StudentEntity alfred = new StudentEntity { Id = Guid.NewGuid(), Course = cSharp, Name = "Alfred", LectureAttandance = new List<LectureEntity>() };
            StudentEntity samantha = new StudentEntity { Id = Guid.NewGuid(), Course = cSharp, Name = "Samantha", LectureAttandance = new List<LectureEntity>() };
